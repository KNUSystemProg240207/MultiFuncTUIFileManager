...
LFLAGS = -lncurses
OBJS = main.o dir_window.o commons.o title_bar.o bottom_area.o list_dir.o process_window.o list_process.o
TARGET = demo.out
...
main.o: config.h commons.h dir_window.h title_bar.h bottom_area.h proc_win.h main.c
	$(CC) $(CFLAGS) -c main.c
...
process_window.o: config.h commons.h proc_win.h process_window.c
	$(CC) $(CFLAGS) -c process_window.c

list_process.o: config.h commons.h proc_win.h list_process.c
